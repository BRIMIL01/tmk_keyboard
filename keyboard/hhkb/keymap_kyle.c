...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
     ...
     *       `-------------------------------------------'
     */
    KEYMAP(FN4, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSLS,FN7, \
    ...
    /* Layer 4: Mouse mode
     * ,-----------------------------------------------------------.
     * |TNS|FN8| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|FN9|TNS|
     * |-----------------------------------------------------------|
     ...
     */
    KEYMAP(TRNS,FN8,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12,FN9, TRNS, \
...
const uint16_t fn_actions[] PROGMEM = {
    ...
    [6] = ACTION_MACRO_TAP(RGUI_PAREN),               // Macro: RGui with tap '('
    [7] = ACTION_LAYER_TAP_KEY(4, KC_GRAVE),          // Hold grave for mouse mode
    [8] = ACTION_MACRO_TAP(TMUX_FULL_SCREEN),         // Macro: Ctrl+A+z (Tmux full screen)
    [9] = ACTION_MACRO_TAP(TMUX_NEXT_SCREEN),         // Macro: Ctrl+A+j (Tmux next screen)
